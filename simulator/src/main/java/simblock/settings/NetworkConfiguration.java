...
public class NetworkConfiguration {
    ...
    /**
     * LATENCY[i][j] is average latency from REGION_LIST[i] to REGION_LIST[j] Unit:
     * millisecond, for
     * year 2015
     */
    ...
    public static final long[][] LATENCY = LATENCY_2024;
     ...
     */
    public static final long[] DOWNLOAD_BANDWIDTH = DOWNLOAD_BANDWIDTH_2024;
    ...
    /**
     * List of upload bandwidth assigned to each region. (unit: bit per second) for
     * year 2024
     */
     ...
     */
    public static final long[] UPLOAD_BANDWIDTH = UPLOAD_BANDWIDTH_2024;
     ...
     */
    public static final double[] REGION_DISTRIBUTION = REGION_DISTRIBUTION_BITCOIN_2024;
