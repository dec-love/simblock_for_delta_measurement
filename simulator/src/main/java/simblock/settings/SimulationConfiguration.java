...
public class SimulationConfiguration {
         ...
         * distribution whose
         * average is AVERAGE_MINING_POWER and standard deviation is
        ...
        public static final int END_BLOCK_HEIGHT = 100;
        // public static final int END_BLOCK_HEIGHT = 21;

        /** Block size. (unit: byte). */
        public static final long BLOCK_SIZE = 2100080;// 535000; // 6110;//8000;//535000;//0.5MB
